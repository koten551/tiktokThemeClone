            ...
            <div className="wide">
                <div className="row">
                    <div className="col l-2 m-2 c-2">
                        <a href="#" style={{ display: "block" }}><img src="./logotiktok.png" alt="logo" className="logo" /> </a>
                    </div>
                    ...
                    <div className="col l-3 m-3 c-3">
                        <div className="right-container">
                            <div>
                                <a href="#" className="" style={{color: "#333", textDecoration: "none", fontSize: "16px", fontWeight: "bold"}}>Upload</a>
                            </div>
